...
| Fichier | Contenu |
|---|---|
| `Misc/reports/controller_architecture.md` | Architecture NMPC+QP, flux de données, contraintes |
| `Misc/reports/momentum_conservation_analysis.md` | Dérivation du terme orbital, choix du point de référence |
| `Misc/reports/refactoring_plan_structure_frame.md` | Plan du refactoring repère structure (complété) |
| `Misc/reports/R5fix_R6new.md` | Cahier des charges R5-fix + R6 (session précédente) |
| `Misc/reports/status_report.md` | Ce document |
