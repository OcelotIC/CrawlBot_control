...
*(Generated by `Misc/scripts/diag_ds_rework_plots.py`. Baseline run with `--baseline_ds_rework` flag = same canonical config but every DS-rework feature disabled.)*
...
PYTHONPATH=. python3 Misc/scripts/diag_ds_rework_plots.py
```
