...
**Memo:** `Misc/reports/architecture/DS_REWORK_CENTROIDAL_2026-06.md` (with actuator-abstraction footnote).
...
cat Misc/reports/architecture/DS_REWORK_CENTROIDAL_2026-06.md
