...
SSMOM_RUN_DIR=figA MUJOCO_GL=disabled PYTHONPATH=. python3 Misc/scripts/postprocess_results_figs.py > "$SP/figA_pp.log" 2>&1; echo "  ppA rc=$?"
SSMOM_RUN_DIR=figB MUJOCO_GL=disabled PYTHONPATH=. python3 Misc/scripts/postprocess_results_figs.py > "$SP/figB_pp.log" 2>&1; echo "  ppB rc=$?"
