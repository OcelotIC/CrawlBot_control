...
Run: MUJOCO_GL=disabled PYTHONPATH=. python3 Misc/scripts/diag_copriority1000_run.py
"""
import os
import json
import numpy as np
...
EPS = 1e-6
WEIGHTS = dict(alpha_torso_pose=300.0, w_hw_slack=1000.0, ss_alpha_mom=400.0,
               alpha_ee=1000.0, alpha_posture=20.0, alpha_wrench=1.0,
               alpha_torque=5.0, alpha_reg=1.0)
SPAN = 1000.0
OUT = 'figC_copri_t300e1000m400'
RESULT_JSON = 'results/j2_adjconv/copri_t300e1000m400_result.json'
...
try:
    ...
    try:
        dca.main(
            ...
            alpha_torso_pose=300.0, ss_alpha_ee=1000.0, ss_alpha_posture=2e1,
