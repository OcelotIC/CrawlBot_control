...
Per Misc/reports/architecture/M7_DS_DIAGNOSTIC_EXPERIMENTS.md. Executes R1/R2/R3/R4
...
def _make_v21_config():
    """v21 baseline config — exactly matches Misc/scripts/run_m7_v21_preplanner_cruise.py."""
...
def main():
    ...
    with open(summary_path, 'w') as f:
        ...
        f.write('Four runs per `Misc/reports/architecture/M7_DS_DIAGNOSTIC_EXPERIMENTS.md`.\n')
