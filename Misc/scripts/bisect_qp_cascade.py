...
Setup matches Misc/scripts/test_qp_tracking.py exactly:
...
Run all cases:
  MUJOCO_GL=disabled PYTHONPATH=. python3 Misc/scripts/bisect_qp_cascade.py --case A
  MUJOCO_GL=disabled PYTHONPATH=. python3 Misc/scripts/bisect_qp_cascade.py --case B
  MUJOCO_GL=disabled PYTHONPATH=. python3 Misc/scripts/bisect_qp_cascade.py --case C
"""
...
def run_v21_case(case: str):
    ...
    # Misc/scripts/ee_null_space_rank.py and Misc/scripts/ee_ang_task_residual.py.
    dump_t_target = 3.6
    dump_done = False
