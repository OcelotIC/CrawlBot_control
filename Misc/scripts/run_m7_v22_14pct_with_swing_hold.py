...
Identical to Misc/scripts/run_m7_v22_with_swing_hold.py (T11), with a single
...
Output:
    Misc/runs/M7_14pct_1step_v22_with_swing_hold/
...
OUT  = os.path.join(_root, 'Misc', 'runs', 'M7_14pct_1step_v22_with_swing_hold')
