...
**Source data:** `Misc/runs/M7_1pct_3step_v22_t15_ik_fix/`
...
- `Misc/runs/M7_1pct_3step_v22_t15_ik_fix/sim_log.json` — per-tick
  reference signals (`p_torso_ref`, `q_torso_ref`, `p_ee_ref`,
  `q_ee_ref`) and actual signals at ~10 Hz.
- `Misc/runs/M7_1pct_3step_v22_t15_ik_fix/physics_trace.pkl` —
