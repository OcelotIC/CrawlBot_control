...
Usage:
    # Plot single run:
    python -m Misc.lutze_baseline.plot_comparison sim_lutze_log.json

    # Compare both:
    python -m Misc.lutze_baseline.plot_comparison sim_lutze_log.json sim_torso6d_log.json
"""
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python -m Misc.lutze_baseline.plot_comparison <log1.json> [log2.json]")
        sys.exit(1)
