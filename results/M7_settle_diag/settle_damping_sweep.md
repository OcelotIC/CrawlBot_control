...
`results/M7_settle_diag/passivity_trace.png` — top: `T_full(t)` on a symlog scale; bottom: passivity LHS on a symlog scale (zero line marked).

## Per-variant trace files

| variant | trace |
|---|---|
| d0_a0 | `results/M7_settle_diag/d0_a0/passivity_trace.csv` |
| d0p005_a0p005 | `results/M7_settle_diag/d0p005_a0p005/passivity_trace.csv` |
| d0p01_a0p01 | `results/M7_settle_diag/d0p01_a0p01/passivity_trace.csv` |
| d0p05_a0p05 | `results/M7_settle_diag/d0p05_a0p05/passivity_trace.csv` |
| d0_a0p05 | `results/M7_settle_diag/d0_a0p05/passivity_trace.csv` |
...
CSV: `results/M7_settle_diag/d0_a0/passivity_trace.csv` — aliased per spec to `results/M7_settle_diag/passivity_trace.csv` (also written).
