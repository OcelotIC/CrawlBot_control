...
- `solref_0p003_1`: `results/M7_settle_diag/weld_sweep/solref_0p003_1/trace.csv`
- `solref_0p001_1`: `results/M7_settle_diag/weld_sweep/solref_0p001_1/trace.csv`
- `solref_direct_stiff`: `results/M7_settle_diag/weld_sweep/solref_direct_stiff/trace.csv`
