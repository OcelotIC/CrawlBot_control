...
`ss_alpha_mom=5000`, `ss_Kp_torso=3`/`Kd=2.5`** (`results/p3b_gate_w24000_kp3/PHASE3_METADATA.txt` and
`results/fixA_gate/PHASE3_METADATA.txt`; runner `run_iterB_gate.sh 24000 3 2.5`). **`run_phase3_gate.sh:15`
