...
## Part 2 — Characterization (canonical 5-step working point = results/fixA_gate flags), raw
...
```
Supporting: `results/j2_aocs_interstep/{aocs_ab.log, aocs_gate.log}`. C6 diff: new-code flag-off vs old-code
