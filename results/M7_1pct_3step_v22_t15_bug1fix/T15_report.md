...
| Output directory | `results/M7_1pct_3step_v22_t15_bug1fix/` |
...
Reference: `results/M7_1pct_3step_v22_t15/` (original T15,
...
T11 reference (`results/M7_1pct_1step_v22_with_swing_hold/metrics.csv`):
