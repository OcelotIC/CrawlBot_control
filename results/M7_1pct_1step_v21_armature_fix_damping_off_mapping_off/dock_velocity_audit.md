...
Log: `results/M7_1pct_1step_v21_armature_fix_damping_off_mapping_off/sim_log.json`. Log cadence `dt = 0.100 s`. Dock event at `t = 7.310 s` (log index `k_dock = 72`). Last SS tick: `k = 71` at `t = 7.210 s`.
