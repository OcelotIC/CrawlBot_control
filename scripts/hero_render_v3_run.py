...
proven by scripts/diag_v3_belt.py).

Run: MUJOCO_GL=osmesa PYTHONPATH=. python3 scripts/hero_render_v3_run.py
"""
import os
...
from scripts.hero_render import make_scene_option, free_cam, build_model, render_pose
from scripts.hero_render_v3 import build_v3_model, render_dark
...
json.dump(dict(
    ...
    dynamics_neutral='proven by scripts/diag_v3_belt.py (see v3_belt_result.json)'),
