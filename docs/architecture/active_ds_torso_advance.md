...
**Plan-of-record location:** `docs/architecture/active_ds_torso_advance.md`
...
- `crawlbot/control/wholebody_qp.py` — same QP, same task stack;
  during DS_active the swing-arm task is simply not added (only
  torso + 2× stance).
- `crawlbot/control/centroidal_nmpc.py` — Option A from §3.5
...
- Update synthesis at
  `docs/architecture/T15_step2_diagnosis_and_resolution.md` with a
...
- `docs/architecture/active_ds_torso_advance.md` (this file)
