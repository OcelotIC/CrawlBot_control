...
class SimConfig:
    ...
    # AOCS mode selection:
    #   'legacy'   : -L_dot feedforward only (spin, original)
    #   'H_est'    : -H_dot estimated feedforward (spin + orbital)
    #   'nmpc_plan': hw_dot from NMPC planned trajectory (self-consistent)
